...
function pegaPokemon(value) {
  axios
    ...
    <div id="${element.ability.name}" class="info"><div class="btn-grad">${element.ability.name}</div></div>`;
      });
      sprite.innerHTML = ` <img class="crop" src="${response.data.sprites.other.home.front_default}"  width="100%" alt="">`;
